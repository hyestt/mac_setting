...
#   -----------------------------
alias uv='/Users/bytedance/.local/bin/uv'
alias gf='git diff'
alias ga='git commit -a --amend'
alias cdc='cd ~/Desktop/workspace/creator_monetization'
# alias go='/Users/bytedance/go/go1.18/bin/go'
...
export PATH=/usr/local/bytesuite-box/bin:$PATH

export PATH=/usr/local/bytesuite-box/homebrew/bin:$PATH
